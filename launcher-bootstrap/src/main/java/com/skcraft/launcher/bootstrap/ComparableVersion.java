 ...
 * <p/>
 * NOTE: This class is a copy of r658725 of
 * http://svn.apache.org/repos/asf/maven/artifact/trunk/src/main/java/org/apache/maven/artifact/versioning/ComparableVersion.java.
 *
...
public class ComparableVersion implements Comparable {
    ...
    private static class StringItem implements Item {
        private static final String[] QUALIFIERS = {
                "snapshot", "alpha", "beta", "milestone", "rc", "", "sp"
        };
        ...
        /**
         * A comparable for the empty-string qualifier. This one is used to determine
         * if a given qualifier makes the version older than one without a qualifier,
         * or more recent.
         */
        private static final Comparable RELEASE_VERSION_INDEX =
                String.valueOf(_QUALIFIERS.indexOf(""));
         ...
         * <p/>
         * This method both takes into account the ordering of known qualifiers as
         * well as lexical ordering for unknown qualifiers.
         */
            ...
            if (c == '.') {
                ...
                if (isDigit) {
                    ...
                    if ((i + 1 < version.length()) && Character.isDigit(version.charAt(i + 1))) {
                        ...
                        // i.e. need to differentiate only 1.1 from 1-1
    ...
    private static Item parseItem(boolean isDigit, String buf) {
        return isDigit ? new IntegerItem(Integer.valueOf(buf)) : new StringItem(buf, false);
    }
